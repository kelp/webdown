...
### Security
- Updated development and transitive dependencies so Safety CI can pass
  (pytest, safety, urllib3, idna, cryptography, authlib, nltk, pygments,
  pymdown-extensions, soupsieve)
...
- Upgraded actions/upload-artifact from v5 to v7 in CI

### Fixed
- Fixed flaky tests in test_claude_xml.py that made real HTTP requests
- Fixed security vulnerabilities in cryptography, authlib, nltk, and requests dependencies
